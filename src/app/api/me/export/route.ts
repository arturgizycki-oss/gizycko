...
export async function GET() {
  ...
  const [user, profile, swipes, matches, messages, posts, comments, reactions, friendships, blocks, reports] =
    await Promise.all([
      ...
      prisma.post.findMany({ where: { authorId: userId }, include: { images: true } }),
